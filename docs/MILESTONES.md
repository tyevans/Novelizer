...
| # | Name | Delivers | Done when | Status |
|---|------|----------|-----------|--------|
| M6 | **Deep Read** | Canon pull tools wired (§4 of pull-tools spec): `CanonBackend` + `search_canon` in Author/Checker/chat runners, push diet (chapter maps replace excerpts), tool telemetry in the Engine Room | Watching the Engine Room, the Author greps chapter 3 while drafting chapter 40; a chat persona answers a continuity question by reading the actual chapter | planned |
